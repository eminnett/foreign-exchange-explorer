...
RSpec.describe Importers::EuropeanCentralBank do
  ...
  describe "#settings" do
    it "returns the importer settings" do
      ...
      expect(settings.keys).to match_array(
        %i[calculate_combinations calculate_inverse silent latest_n_days]
      )
    end
  end
  ...
  describe "#process_exchange_rates" do
    ...
    context "when calculate_combinations and calculate_inverse are false" do
    ...
    context "when calculate_combinations is false and " \
      "calculate_inverse is true" do
      let(:importer) do
  ...
  describe "#calculate_combinations!" do
    ...
    it "returns all combinations of rates based on the given data" do
      ...
      combinations = importer.calculate_combinations!(copy)
